...
خدمة يومية راقية تُقدّم لك:
• حالة الطقس الحالية
• وصف دقيق للأجواء
• سرعة الرياح
• أوقات الصلاة المعتمدة
...
مرحباً بك في التجربة اليومية الراقية.

━━━━━━━━━━━━━━
{msg}
━━━━━━━━━━━━━━

📅 سيصلك التحديث يومياً الساعة <b>04:00 صباحاً</b>
"""
        )
        return {"ok": True}
    ...
    if text.lower() in ["change", "تغيير"]:
        ...
        send_message(
            chat_id,
            """
✏️ <b>تم إلغاء المدينة الحالية.</b>

يرجى إدخال اسم مدينتك الجديدة بالإنجليزية.
"""
        )
        return {"ok": True}
